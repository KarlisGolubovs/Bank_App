...
<div class="mx-auto mt-8 max-w-sm">
    <div class="rounded-lg bg-gray-100 p-6 shadow-lg">
        ...
        <form method="POST" action="{{ route('store.account') }}" class="space-y-6">
            @csrf
            <div class="mb-4">
            ...
            <div class="mt-4 flex items-center justify-between">
                <a href="{{ route('account') }}" class="text-sm text-gray-600 underline hover:text-gray-900">Back to Account</a>
